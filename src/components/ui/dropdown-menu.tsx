...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        'flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none focus:bg-accent data-open:bg-accent [&_svg]:size-4',
        inset && 'pl-8',
        className
      )}
      {...props}
...
function DropdownMenuSubContent({
  ...
  return <DropdownMenuContent className={cn('min-w-24', className)} {...props} />
}
...
export {
  ...
  DropdownMenuGroup, DropdownMenuLabel, DropdownMenuItem, DropdownMenuSub,
  DropdownMenuSubTrigger, DropdownMenuSubContent, DropdownMenuSeparator, DropdownMenuShortcut,
}
